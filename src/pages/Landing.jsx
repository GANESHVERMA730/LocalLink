      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-primary-50/80 to-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="font-display text-3xl font-bold leading-tight text-ink-900 sm:text-5xl lg:text-6xl">
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-4 lg:grid-cols-6">
          {SERVICE_CATEGORIES.slice(0, 12).map((cat) => (
            <div
              key={cat.value}
              className="group flex flex-col items-center gap-3 rounded-2xl border border-ink-100 bg-white p-4 text-center transition-all hover:border-primary-200 hover:shadow-card-hover sm:p-5"
            >
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:items-center lg:gap-12">
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            <div className="card p-4 sm:p-6">
              ...
              <p className="mt-4 text-2xl font-bold text-ink-900 sm:text-3xl">12+</p>
              <p className="text-sm text-ink-500">Service categories</p>
            </div>
            <div className="card p-4 sm:mt-8 sm:p-6">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-accent-50 text-accent-600">
                <Star size={20} />
              </div>
              <p className="mt-4 text-2xl font-bold text-ink-900 sm:text-3xl">Live</p>
            ...
            <div className="card p-4 sm:p-6">
              ...
              <p className="mt-4 text-2xl font-bold text-ink-900 sm:text-3xl">2 roles</p>
            ...
            <div className="card p-4 sm:mt-8 sm:p-6">
              ...
              <p className="mt-4 text-2xl font-bold text-ink-900 sm:text-3xl">Geo</p>
...
function Step({ icon, step, title, description }) {
  return (
    <div className="relative overflow-hidden rounded-2xl bg-white p-6 shadow-card sm:p-8">
      <div className="absolute right-5 top-5 text-4xl font-bold text-ink-100 sm:right-6 sm:top-6">{step}</div>
      <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-primary-600 text-white">
        {icon}
      </div>
      <h3 className="pr-12 text-lg font-semibold text-ink-900">{title}</h3>
